  ...
  <Layout>
    <section>
      ...
      <p itemScope itemType="http://schema.org/Person">
        ...
        >
          <span itemProp="streetAddress">Bahnhofsiedlung 5</span>
          <br />
          <span itemProp="postalCode">39365</span>{' '}
          <span itemProp="addressLocality">Sommersdorf OT Marienborn</span>
        </span>
      </p>
      <p>
      ...
      <p itemType="http://schema.org/Person">
        Mobil:{' '}
        <a href="tel:+491604623511">
          <span itemProp="telephone">+49 (0) 160 4623511</span>
        </a>
        <br />
        Telefon:{' '}
        <a href="tel:+4939400920624">
          <span itemProp="telephone">+49 (0) 39400 920624</span>
        </a>
        <br />
        E-Mail:{' '}
        <a href="mailto:info@unikka.de" itemProp="email">
          info@unikka.de
        </a>
      </p>
